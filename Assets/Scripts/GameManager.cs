...
public class GameManager : MonoBehaviour
{
    ...
    public int _ChangeCount = default;
    ...
    {
        _DestroyCount = _DestroyCount + 1;
        if(_DestroyCount == _ChangeCount)
        {
            GameObject.FindObjectOfType<EnemyManager>
            ().StartEnemy();
        }
